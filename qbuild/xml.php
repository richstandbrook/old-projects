...
*
* @package xml
* @copyright © 2002,2003 Patrick Deegan, Psychogenic.com. All rights reserved.
* @author Patrick Deegan <http://minixml.psychogenic.com>
*
...
define("MINIXML_CLASSDIR", "$MiniXMLLocation/xml");
